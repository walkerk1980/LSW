...
struct TrackedIpAddress
{
    ...
    lsw::shared::hns::IPAddress ConvertToHnsSettingsMsg() const
    {
        lsw::shared::hns::IPAddress addr{};
...
struct TrackedRoute
{
    ...
    lsw::shared::hns::Route ConvertToHnsSettingsMsg() const
    {
...
struct IpStateTracking
{
    ...
    {
        LSW_LOG("IpStateTracking::ResetState");
